		...
		<div class="row">
			...
			<div class="col-md-12 mt-3">
				<div class="card paint-card">
					<div class="card-body">
						<h4 class="fs-3 text-center mb-4">Doctor Details</h4>
								...
								<tbody>
									...
									<tr>
										...
										<td><a href="edit_doctor.jsp?id=<%=d.getId() %>"
											class="btn btn-sm btn-primary custom-width me-3 text-center">Edit</a>
											
											<a href="../deleteDoctor?id=<%=d.getId() %>"
											class="btn btn-sm btn-danger custom-width text-center">Delete</a>
