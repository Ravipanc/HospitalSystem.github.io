		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="../addSpecialist" method="POST" id="addSpecialistForm">
						<div class="form-group">
							<label for="specName">Enter Specialist Name</label> <input
								type="text" name="specName" id="specName" class="form-control">
						</div>
